        ...
        <div className="text-lg">
          <div className="rounded-3xl border border-gray-800 bg-base-100 text-gray-800">
            <div className="m-12 flex flex-col lg:flex-row justify-around">
              <a href="/whitepaper.pdf" download className="flex flex-col rounded-3xl sm:p-10 lg:w-2/5 justify-between transition-all hover:scale-105 sm:hover:bg-[#FFFFFF] sm:hover:border-black border border-base-100 sm:hover:shadow-xl cursor-pointer">
                <div className='mb-20'>
