...
export default function Stats() {
  return (
    <div className="xs:-mt-32 m-0 w-screen justify-items-center border-t border-gray-800 bg-base-100 grid">
        ...
        <div className="text-lg">
          <div className="rounded-3xl border border-gray-800 bg-base-100 text-gray-800">
            <div className="grid grid-cols-2 grid-rows-3 justify-center p-10 lg:grid-cols-3 lg:grid-rows-2">
              <h1 className="rows-span-1 col-span-2 sm:m-2 md:m-5 lg:col-span-1 lg:row-span-2 lg:py-10 text-3xl sm:text-4xl lg:text-5xl">
                Protocol Stats
              </h1>
