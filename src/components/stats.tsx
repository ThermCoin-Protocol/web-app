...
export default function Stats() {
  return (
    <div className="-mt-32 m-0 w-screen justify-items-center border-t border-base-content bg-base-100 grid">
        ...
        <div className="text-lg">
          <div className="rounded-3xl border border-base-content bg-base-100 text-base-content">
            <div className="grid grid-cols-2 grid-rows-3 justify-center p-10 lg:grid-cols-3 lg:grid-rows-2">
              <h1 className="rows-span-1 col-span-2 text-4xl sm:m-2 sm:text-5xl md:m-5 lg:col-span-1 lg:row-span-2 lg:py-10 lg:text-6xl">
                Protocol Stats
              </h1>
