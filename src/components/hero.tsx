    ...
    <div className="hero min-h-screen bg-[url('./bg.jpg')]">
      ...
      <div className="hero-content text-center text-primary-content">
        <div className="max-w-xl">
          ...
          <button className="btn m-2 btn-lg text-primary-content hover:text-info">Start Mining</button>
          <button className="btn m-2 btn-lg text-primary-content hover:text-info">Community Pool</button>
        </div>
      </div>
    </div>
  );
